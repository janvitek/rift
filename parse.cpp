...
void Idx::accept(Visitor* v) {
    v->visit(this);
}
void SimpleAssign::accept(Visitor* v) {
    v->visit(this);
}
void IdxAssign::accept(Visitor* v) {
    v->visit(this);
}
...
#define EAT(T)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     \
    if (token() != T) {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            \
        error("Failed expecting ", tok_to_str(T));                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
    } else {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       \
        advance();                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 \
    }
...
Exp* Parser::parseBinExp(Exp* l) {
    Token t = token();
    if (t != DIV && t != PLUS && t != MIN && t != MUL && t != LT && t != EQ)
        return l;
